...
function toLocalSet(input: {
  ...
  return {
    id: createId('set'),
    title: input.title.trim() || 'Nieuwe studieset',
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-sm font-semibold text-foreground">
                Gekozen vakken ({selectedSubjects.length})
              </label>
              <button
                type="button"
    ...
    >
      <div className="relative w-full max-w-md rounded-2xl border border-border bg-card p-6 shadow-2xl my-auto text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Geweldig bezig! Blijf elke dag oefenen.
        </p>
        <button
          onClick={onClose}
...
function ImportPanel({
  ...
  const handleImportText = () => {
    if (preview.length === 0) {
      setError('Geen kaarten herkend. Controleer de scheidingstekens.');
      return;
    }
    onImport(preview);
    setRawText('');
    ...
    <div className="rounded-xl border border-border bg-card overflow-hidden">
      <div className="p-5 space-y-4">
        <p className="text-xs text-muted-foreground">
          Plak tekst uit Quizlet, Word, of Excel. Elke rij is een kaart. Standaard scheiding:{' '}
          <strong>tab</strong> tussen term en definitie, <strong>nieuwe regel</strong> tussen
          kaarten.
        </p>
        ...
        {preview.length > 0 && (
          <div>
            <p className="text-xs font-semibold text-muted-foreground mb-2">
              {preview.length} kaarten herkend:
            </p>
            <div className="max-h-36 overflow-y-auto space-y-1 rounded-lg border border-border bg-background p-3">
              ...
              {preview.length > 8 && (
                <p className="text-xs text-muted-foreground pt-1">+{preview.length - 8} meer...</p>
              )}
            </div>
          </div>
        )}
        ...
        >
          ...
          {preview.length > 0 ? `${preview.length} kaarten importeren` : 'Importeren'}
        </button>
      </div>
    </div>
  );
    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-3xl px-6 pb-24">
        ...
        <section className="flex flex-wrap items-end justify-between gap-6 border-b border-border py-8">
          <div>
            <p className="text-[11px] uppercase tracking-[0.18em] text-muted-foreground">Maken</p>
          ...
          <div>
            ...
            {!showImport && (
              <span className="ml-3 text-xs text-muted-foreground">
                Plak tekst uit Quizlet, Word of Excel
              </span>
            )}
          </div>
  ...
  const lessons = [
    {
      id: 1,
      subject: 'Wiskunde B',
      title: 'Differentiëren – Basisregels',
      duration: '45 min',
      progress: 60,
      level: 'VWO 5',
    },
    {
      id: 2,
      subject: 'Biologie',
      title: 'Fotosynthese & Celademhaling',
      duration: '30 min',
      progress: 0,
      level: 'VWO 5',
    },
    ...
    },
    {
      ...
      title: 'Tweede Wereldoorlog – Oorzaken',
      duration: '35 min',
      progress: 100,
      level: 'VWO 5',
    },
    {
      id: 5,
      subject: 'Engels',
      title: 'Grammatica: Present Perfect',
      duration: '20 min',
      progress: 80,
      level: 'VWO 5',
    },
    ...
    <div className="mx-auto max-w-6xl px-6 pb-24">
      ...
      <div className="mt-10 rounded-xl border border-dashed border-border bg-background/50 p-8 text-center">
        ...
        <h3 className="font-display text-xl font-semibold text-foreground">
          Meer lessen komen eraan
        </h3>
        <p className="mt-1 text-sm text-muted-foreground">
          We werken aan meer lessen voor al je vakken.
        </p>
      </div>
    </div>
  );
...
function CalendarPage({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="mx-auto max-w-[1400px] px-8 pb-24">
      ...
      <section className="flex flex-wrap items-end justify-between gap-6 border-b border-border py-8">
        <div className="max-w-xl">
          <p className="text-[11px] uppercase tracking-[0.18em] text-muted-foreground">Planning</p>
          <h1
            style={{ fontFamily: 'Cormorant Garamond, serif' }}
            className="mt-3 text-5xl font-semibold leading-[1.1]"
          >
            Kalender
          </h1>
          ...
          <div className="overflow-hidden rounded-lg border border-border">
            ...
            <div className="grid grid-cols-7 border-b border-border bg-secondary/40">
              {dayNames.map((day) => (
                <div
                  key={day}
                  className="border-r border-border p-3 text-center text-[11px] uppercase tracking-[0.14em] text-muted-foreground last:border-r-0"
                >
                  {day}
                </div>
              ))}
            ...
            <div className="grid grid-cols-7">
              ...
              {Array.from({ length: (firstDayOfMonth + 6) % 7 }).map((_, i) => (
                <div
                  key={`empty-${i}`}
                  className="border-r border-b border-border bg-secondary/10 p-3 min-h-[100px]"
                />
              ))}
              ...
              {Array.from({ length: daysInMonth }).map((_, i) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`inline-flex h-6 w-6 items-center justify-center rounded-full text-sm font-semibold ${isToday ? 'bg-primary text-primary-foreground' : 'text-foreground'}`}
                    >
                      {dayNumber}
                    </span>
...
const SUBJECT_DIRECTORY: SubjectTree[] = [
  ...
  },
  {
    ...
    units: [
      ...
      {
        name: 'Hoofdstuk 2 – Differentiëren',
        sets: ['Basisregels', 'Kettingregel & productregel'],
      },
  ...
  },
  {
    ...
    units: [
      {
        name: 'Hoofdstuk 1 – Cel & stofwisseling',
        sets: ['Celonderdelen', 'Fotosynthese & ademhaling'],
      },
  ...
  },
  {
    ...
    units: [
      ...
      {
        name: 'Hoofdstuk 4 – Organische chemie',
        sets: ['Koolwaterstoffen', 'Functionele groepen'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    units: [
      ...
      {
        name: 'Hoofdstuk 2 – Vroegmoderne tijd',
        sets: ['Renaissance & Reformatie', 'VOC & kolonialisme'],
      },
  ...
  },
  {
    ...
    units: [
      ...
      {
        name: 'Hoofdstuk 2 – Bedrijf & productie',
        sets: ['Kosten & opbrengsten', 'Productieprocessen'],
      },
  ...
  },
  {
    ...
    units: [
      ...
      {
        name: 'Deel 2 – Financiering',
        sets: ['Eigen & vreemd vermogen', 'Investeringsberekeningen'],
      },
    ],
  },
  {
...
function seedSubjectFolders(userSubjects: string[], existingFolders: LocalFolder[]): LocalFolder[] {
        ...
        {childFolders.length === 0 && currentSets.length === 0 ? (
          <div className="rounded-xl border border-dashed border-border bg-background p-12 text-center">
            ...
            <p className="text-sm mt-1 text-muted-foreground">
              Maak een submap of verplaats studiesets hierheen.
            </p>
          </div>
        ) : (
...
function SimpleFlashcard({ cards }: { cards: LocalCard[] }) {
  ...
  if (cards.length === 0)
    return <p className="text-center text-muted-foreground py-8">Geen kaarten.</p>;
    ...
    <div className="mx-auto max-w-4xl px-6 pb-24">
      ...
      <section className="flex flex-wrap items-end justify-between gap-6 border-b border-border py-8">
        <div className="max-w-xl min-w-0">
          <p className="text-[11px] uppercase tracking-[0.18em] text-muted-foreground">Studieset</p>
...
type MainScreen =
  'home' | 'library' | 'create' | 'folders' | 'lessen' | 'calendar' | 'study-detail';
  ...
  const practiceRows = useMemo(() => {
    ...
    return subs.map((sub) => {
      ...
      if (subjectSets.length > 0) {
        ...
        return {
          title: sub,
          subtitle: `${userProfile.schoolLevel} ${userProfile.year} · ${totalSets} ${totalSets === 1 ? 'set' : 'sets'}`,
          done: studiedCards,
          ...
          <section className="grid gap-8 border-b border-border py-12 md:grid-cols-[1.4fr_1fr] md:items-end">
            <div>
              <p className="text-[11px] uppercase tracking-[0.18em] text-muted-foreground">
                ...
                {userProfile.selectedSubjects.length} VAKKEN
              </p>
              <h1
                style={{ fontFamily: 'Cormorant Garamond, serif' }}
              ...
              <p className="mt-3 max-w-md text-sm leading-relaxed text-muted-foreground">
                ...
                kaarten klaarstaan om te herhalen. Begin bij{' '}
                {sets.length > 0 ? sets[0].title : 'je eerste set'}—daar loopt je beheersing het
                meest achter.
              </p>
              ...
              <div>
                ...
                <p className="mt-4 text-xs leading-relaxed text-muted-foreground">
                  {(() => {
                    ...
                    return `Gemiddeld ${avgPerDay} ${avgPerDay === 1 ? 'kaart' : 'kaarten'} per dag deze week.`;
                  })()}
                </p>
              </div>
            </aside>
