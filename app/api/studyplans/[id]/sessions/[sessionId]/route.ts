...
import { getStudyPlanById, getStudySessionById, updateStudySession, deleteStudySession } from "@/lib/studyplans";
...
export async function GET(
  ...
  try {
    ...
    if (session.studyPlanId !== params.id) {
      return NextResponse.json({ error: "Session does not belong to this study plan" }, { status: 400 });
    }
