...
import { getUserAchievements, getAchievementDefinitions, checkAndUnlockAchievements } from "@/lib/achievements";
...
export async function GET(request: NextRequest) {
  try {
    ...
    let achievements;
    if (unlocked === "true") {
      achievements = (await getUserAchievements(payload.userId)).filter(a => a.unlockedAt !== null);
