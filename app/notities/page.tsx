    ...
    return (
      <main className="flex-1 grid place-items-center bg-muted/20">
        <div className="text-center text-muted-foreground">
          ...
          <p className="text-sm">Selecteer een pagina om te bewerken</p>
        </div>
      </main>
    );
  }
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none">
          <p className="text-muted-foreground">
            Inhoud van de pagina wordt hier geladen met BlockNote editor...
          </p>
        </div>
      </div>
    </main>
  ...
  return (
    <AppShell>
      <PageHeader
        eyebrow="Kennisbank"
        title="Notities"
        description="Beheer je notities in een Obsidian-achtige werkruimte met mappen en pagina's."
      />
