    ...
    <AppShell>
      ...
      <div className="mt-10 max-w-4xl space-y-8">
        <section>
          ...
          <p className="text-muted-foreground">{t('privacy_info_text')}</p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold mb-4">{t('privacy_how_we_use')}</h2>
          <p className="text-muted-foreground">{t('privacy_how_we_use_text')}</p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold mb-4">{t('privacy_data_security')}</h2>
          <p className="text-muted-foreground">{t('privacy_data_security_text')}</p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold mb-4">{t('privacy_your_rights')}</h2>
          <p className="text-muted-foreground">{t('privacy_your_rights_text')}</p>
        </section>
