  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "sidebar-primary-foreground": "oklch(from var(--sidebar-primary-foreground) l c h / <alpha-value>)",
        "sidebar-accent": "oklch(from var(--sidebar-accent) l c h / <alpha-value>)",
        "sidebar-accent-foreground": "oklch(from var(--sidebar-accent-foreground) l c h / <alpha-value>)",
